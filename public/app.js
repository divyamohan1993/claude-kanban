...
function showOnboarding() {
  if (localStorage.getItem('claude-kanban-onboarded')) return;
  ...
  function renderStep() {
    ...
    if (step === 0) {
      ...
      for (var fi = 0; fi < flowSteps.length; fi++) {
        if (fi > 0) flowRow.appendChild(el('span', { class: 'onboarding-flow-arrow' }, '\u2192'));
      ...
      var linkStyle = 'display:flex;align-items:center;gap:12px;padding:12px 16px;background:var(--bg);border:1px solid var(--border);border-radius:8px;text-decoration:none;color:var(--text);transition:border-color 0.15s;text-align:left';
      var iconStyle = 'font-size:18px;width:28px;height:28px;display:flex;align-items:center;justify-content:center;flex-shrink:0;border-radius:6px;background:var(--primary-soft);color:var(--primary-text)';
      var productLink = el('a', { href: '/product/', style: linkStyle, target: '_blank' });
      productLink.appendChild(el('span', { style: iconStyle }, '\u25C6'));
      var prodText = el('div', { style: 'min-width:0' });
      ...
      var featLink = el('a', { href: '/product/features/', style: linkStyle, target: '_blank' });
      featLink.appendChild(el('span', { style: iconStyle }, '\u2699'));
      var featText = el('div', { style: 'min-width:0' });
  ...
  function dismiss() {
    localStorage.setItem('claude-kanban-onboarded', '1');
